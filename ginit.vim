...
for i in [1,2,3,4,5,6,7,8,9]
  ...
  execute "nnoremap <silent> <M-" . i . ">            :tabnext " . i . "<cr>"
  execute "vnoremap <silent> <M-" . i . ">       <c-u>:tabnext " . i . "<cr>"
  execute "tnoremap <silent> <M-" . i . "> <c-\\><c-n>:tabnext " . i . "<cr>"
endfor
...
execute "nnoremap <silent> <M-" . i . ">            :tabnext 10<cr>"
execute "vnoremap <silent> <M-" . i . ">       <c-u>:tabnext 10<cr>"
execute "tnoremap <silent> <M-" . i . "> <c-\\><c-n>:tabnext 10<cr>"
