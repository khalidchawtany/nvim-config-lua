return {
    ...
    config = function()
        vim.env.OPENAI_API_KEY = require("user.functions").read_file("/Users/juju/.local/share/nvim/keys/openai.txt")
...
Respect and use existing conventions, libraries, etc that are already present in the code base.
            ...
            openai = {
                ...
                max_tokens = 4096,
                ["local"] = false,
                -- api_key_name = require("user.functions").read_file("/Users/juju/.local/share/nvim/keys/openai.txt"),
                -- api_key_name = "HELP",
            },
            ---@type AvanteSupportedProvider
            copilot = {
            ...
            claude = {
                ...
                max_tokens = 8000,
                ["local"] = false,
                api_key_name = require("user.functions").read_file("/Users/juju/.local/share/nvim/keys/claude.txt"),
            },
            ---@type AvanteSupportedProvider
            gemini = {
            ...
            vendors = {
                ...
                groq = {
                    ...
                    api_key_name = require("user.functions").read_file("/Users/juju/.local/share/nvim/keys/groq.txt"),
