return {
    ...
    init = function()
        require("plugins.ai.codecompanion.utils_fidget-spinner"):init()
    end,
    config = function()
        vim.keymap.set(
            { "n", "v" },
        ...
        require("codecompanion").setup({
            strategies = {
                chat = {
                    tools = {
                        calculator = require("plugins.ai.codecompanion.tools-calculator"),
                    },
                    adapter = "copilot",
                    keymaps = {
                        send = {
                    ...
                    slash_commands = {
                        ["Think_AND_Reason"] = require("plugins.ai.codecompanion.slash_command_reasoning"),
                        ["file"] = {
            ...
            adapters = {
                ...
                -- 	})
                -- end,
                kimi = require("plugins.ai.codecompanion.adapters_kimi"),
                anthropic = function()
