...
function floatFugitive (dir)
  ...
  local win_opts = {border = "rounded", col = ((ui.width - win_width) / 2), height = win_height, relative = "editor", row = ((ui.height - win_height) / 2), style = "minimal", width = win_width}
...
return {
	...
	keys = {
		{ "<leader>gf",        function() floatFugitive('.') end, desc = "Git (Float)" },
