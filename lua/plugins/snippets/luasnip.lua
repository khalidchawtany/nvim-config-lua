...
M.config = function()
  ...
  require("luasnip.loaders.from_lua").load({paths = vim.fn.stdpath("config") .. "/luasnip_snippets/"})
  require("luasnip.loaders.from_vscode").load(
    {paths = {vim.fn.stdpath("config") .. "/vscode_snippets/", "~/.local/share/nvim/lazy/friendly-snippets/"}}
  )
