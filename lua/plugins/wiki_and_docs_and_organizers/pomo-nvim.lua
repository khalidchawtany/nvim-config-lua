    ...
    config = function()
        ...
        PrintNotifier.tick = function(self, time_left)
            if not self.hidden then
                vim.notify(string.format("Timer #%d, %s, %ds remaining...", self.timer.id, self.timer.name, time_left))
            end
        end

        PrintNotifier.done = function(self)
            vim.notify(string.format("Timer #%d, %s, complete", self.timer.id, self.timer.name))
