    ...
    october = {
        {
            ...
            paths = { { "plugins" } },
            prompt = "lang",
            fd_opts = { "--full-path", "-g", "**/khalid/**/lang/**/*.php" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "yaml",
            fd_opts = { "--full-path", "-g", "**/khalid/**/*.yaml" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "yaml",
            fd_opts = { "--full-path", "-g", "**/khalid/**/controllers/*/*.yaml" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "yaml",
            fd_opts = { "--full-path", "-g", "**/khalid/**/models/*/*.yaml" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "migrations",
            fd_opts = { "--full-path", "-g", "**/khalid/**/updates/*" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "components",
            fd_opts = { "--full-path", "-g", "**/khalid/**/components/*.php" },
        },
        {
            desciption = "M-Componenets (OCT)",
            keys = "<leader>lo",
            paths = { { "plugins" } },
            prompt = "components",
            fd_opts = { "--full-path", "-g", "**/khalid/**/components/**" },
        },
        {
        ...
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "controllers",
            fd_opts = { "--full-path", "-g", "**/khalid/**/controllers/*.php" },
        },
        {
        ...
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "controllers",
            fd_opts = { "--full-path", "-g", "**/khalid/**/controllers/**" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "Classes (Util)",
            fd_opts = { "--full-path", "-g", "**/khalid/**/classes/**" },
        },
        {
            ...
            paths = { { "plugins" } },
            prompt = "models",
            fd_opts = { "--full-path", "-g", "**/khalid/**/models/*.php" },
        },
        {
            desciption = "M-Models (OCT)",
            keys = "<leader>ln",
            paths = { { "plugins" } },
            prompt = "models",
            fd_opts = { "--full-path", "-g", "**/khalid/**/models/*/*" },
        },
        {
        ...
        {
            desciption = "khalid (OCT)",
            keys = "<leader>l<leader>",
            paths = { { "plugins" } },
            prompt = "all",
            fd_opts = { "--full-path", "-g", "**/khalid/**/*" },
        },
        {
